...
<head>
    ...
    <!--必要样式-->
    <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/cairs00/xyplay@master/include/jquery.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/cairs00/xyplay@master/include/class.main.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/dashjs/dist/dash.all.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/flv.js/dist/flv.min.js"></script>
    ...
    <script>
        document.write('<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/dplayer/dist/DPlayer.min.js" ><\/script> ');
    </script>
    <script>
        if (_GET('logo_off') === "1") {
